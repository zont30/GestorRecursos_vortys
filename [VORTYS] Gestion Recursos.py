...
tv['columns']= ('Cuadrilla', 'Nombre', 'Progreso', 'Nivel', 'Cansancio', 'Disponible', 'Tarea')
...
tv.column('Cansancio',anchor="center", width=70)
...
tv.heading('Cansancio', text='Cansancio', anchor="center")
